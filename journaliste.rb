...
puts "nombre de journaliste"

puts handle.length
puts "__________________________"
puts" ======"
puts "   "
puts "handle contenant de chiffre"

puts handle.select{|x| /\d/.match(x)}
puts "__________________________"
puts " "
puts "contenant aude"

puts 
mitadyaude = Proc.new {|x| /aude/.match(x.downcase)}
puts handle.select(&mitadyaude).count
puts "__________________________"
puts " "
puts "commence par Maj"
puts
commence = Proc.new {|x| /@[A-Z]/.match(x)}
puts handle.select(&commence).count
puts "__________________________"
puts "contenant de Maj"

puts
avecmaj = Proc.new {|x| /[A-Z]/.match(x)}
puts handle.select(&avecmaj).count
puts "__________________________"
puts " ====="
puts "underscore"
undersco = Proc.new {|x| /[_]/.match(x)}
puts handle.select(&undersco).count
puts "__________________________"
